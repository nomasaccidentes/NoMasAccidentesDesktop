 ...
 * @author AlexF
 */
public class SolicitudCapacitacionService {
    ...
    public JSONArray getSolicitudAsesoria(){
        String urlAPi = URL + "solicitudCapacitacion/getSolicitud";
        try {
     ...
     public String putSolicitudAsesoria(SolicitudCapacitacion solicitud, int id) throws Exception{
        String urlAPi = URL + "solicitudCapacitacion/editaSolicitudCapacitacion/"+id;
        try {
            URL url = new URL(urlAPi);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
