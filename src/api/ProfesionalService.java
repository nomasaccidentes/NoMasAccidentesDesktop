...
public class ProfesionalService {
    ...
    public JSONArray getProfesional(){
        String urlAPi = URL + "profesional/GetProfesional";
        try {
     ...
     public String postProfesional(Profesional p) throws Exception{
        String urlAPi = URL + "profesional/InsertProfesional";
        try {
            URL url = new URL(urlAPi);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
